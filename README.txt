This script returns relevant information about advertising campaigns using the Amplify API.
...
do not change the file location or name as the script will fail.
...
the script creates a csv file at the script's location named Jan_campaigns.csv which contains all the data for campaigns in the month of January.
